...
- Custom `QuikkTools` toolbar icon for quick recognition
- Grouped toolbar sections for `Logs`, `Diagnostics`, and `Utilities`
- `QuikkTools -> Logs -> Export Current Project Log` toolbar menu entry
